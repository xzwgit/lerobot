...
> Fork of [huggingface/lerobot](https://github.com/huggingface/lerobot) kept alongside [xzwgit/openpi (branch `cu130-blackwell`)](https://github.com/xzwgit/openpi/tree/cu130-blackwell) — the π₀/π0.5 reference implementation switched to torch 2.14.0+cu130 with Blackwell (RTX 5090 / RTX PRO 6000) support.
